//====================================================================================
// FILE:    UserInput ----------------------------------------------------------------
// PURPOSE: Main input class - contains key information and handles whether ----------
//          a specific key has been pressed ------------------------------------------
//------------------------------------------------------------------------------------
...
enum EKeyCode
{
	...
	MOUSE_RBTN = 0x02,  // Right mouse button
	MOUSE_MBTN = 0x04,  // Middle mouse button
	MOUSE_XBTN1 = 0x05,  // Windows 2000/XP: X1 mouse button
	MOUSE_XBTN2 = 0x06,  // Windows 2000/XP: X2 mouse button
	...
	MAX_KEY_CODES = 0x100  // Maximum number of key codes
};
